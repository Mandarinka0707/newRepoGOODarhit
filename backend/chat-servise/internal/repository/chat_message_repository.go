...
type ChatMessageRepository interface {
	CreateChatMessage(ctx context.Context, message *entity.ChatMessage) (int64, error)
...
func (r *chatMessageRepository) CreateChatMessage(ctx context.Context, message *entity.ChatMessage) (int64, error) {
